...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference("Name.count") do
      post names_url, params: { name: { author: @name.author, category: @name.category, price: @name.price } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { author: @name.author, category: @name.category, price: @name.price } }
